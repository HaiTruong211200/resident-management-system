...
export const HouseholdPage: React.FC<HouseholdPageProps> = ({ onSelectHousehold }) => {
  const { households, residents, addHousehold, editHousehold, deleteHousehold } = useAppContext();
                ...
                <tr key={household.id} className="hover:bg-blue-50/50 group transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end space-x-2">
                      ...
                      <button 
                        onClick={() => { if(window.confirm('Xóa hộ khẩu này? Dữ liệu nhân khẩu liên quan sẽ bị ảnh hưởng.')) deleteHousehold(household.id); }}
